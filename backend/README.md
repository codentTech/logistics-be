...
├── modules/               # Feature modules (organized by concern)
│   ├── auth/
...
### Shipments
- `GET /v1/shipments` - Get all shipments (with optional status filter)
...
### Drivers
- `GET /v1/drivers` - Get all drivers (with real-time locations)
- `GET /v1/drivers/:id` - Get driver by ID (with location)
